const getAllAttendance = async () => {
  var attendance;
  await $.post("GetAllAttendance").done((data, status) => {
    attendance = data;
  });
...
const getAttendanceByLessonId = async (id) => {
  var attendance;
  await $.post("GetAttendanceByLessonId", {
    lesson_id: id,
  }).done((data, status) => {
    attendance = data;
  });
